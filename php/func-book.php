...
function get_books_by_owner($con, $owner_id){
   $sql  = "SELECT * FROM books WHERE owner_id=? ORDER BY id DESC";
   $stmt = $con->prepare($sql);
...
function search_books($con, $key, $owner_id = null){
   $key = "%{$key}%";
